...
class Designer // extends Model
{
   ...
   public function decimal(string $name, string $size = "10.0")
   {
      // increment the field count
      $this->field_index++;
      // indicate that other options can now be passed
   ...
   public function double(string $name, string $size = "10.0")
   {
      // increment the field count
      $this->field_index++;
      // indicate that other options can now be passed
   ...
   public function float(string $name, string $size = "10.0")
   {
      // increment the field count
      $this->field_index++;
      // indicate that other options can now be passed
   ...
   public function real(string $name, string $size = "10.0")
   {
      // increment the field count
      $this->field_index++;
      // indicate that other options can now be passed
